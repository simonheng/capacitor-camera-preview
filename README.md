...
| **`preloadVideo`**                 | <code>boolean</code>                                            | If true, preloads video capture capabilities when the camera starts. If false, video capture is only initialized when startRecordVideo is called.                                                       | <code>false</code>    | 7.11.0 |
